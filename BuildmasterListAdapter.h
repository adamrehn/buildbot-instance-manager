...
*/
#ifndef _BUILDBOT_INSTANCE_MANAGER_BUILDMASTER_LIST_ADAPTER
#define _BUILDBOT_INSTANCE_MANAGER_BUILDMASTER_LIST_ADAPTER

#include <QAbstractTableModel>

#include "BuildbotInstanceScanner.h"

class BuildmasterListAdapter : public QAbstractTableModel
{
	Q_OBJECT

    public:
        explicit BuildmasterListAdapter(BuildbotInstanceScanner* instances, QObject *parent = 0);
